...
## 非root的普通用户使用tmux方法教程
 ...
 发表于 2020-12-24 | 分类于 [运维技术](https://wandouduoduo.github.io/categories/运维技术/) > [命令详解](https://wandouduoduo.github.io/categories/运维技术/命令详解/) | 阅读次数：450
...
make
#这个时候会报错 configure: error: "curses not found" 只需要把./local/include/ncurses 里面的全部复制#到./local/include
cp tmux ~/.local/bin
```
